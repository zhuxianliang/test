 ...
 * @Date: 2024-12-20 16:07:12
 * @LastEditors: v-zhuxianliang v-zhuxianliang@360.cn
 * @LastEditTime: 2024-12-23 15:20:34
 * @FilePath: \test\src\components\skany.vue
...
async function init() {
  ...
  let data = uniqueNodes.map((item, index) => {
    ...
    return {
      name: item,
      itemStyle: {
        color: position ? colorMap[index] : setOpacity(colorList[index], 0.6),
